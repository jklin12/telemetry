...
//
//     final hydrographModel = hydrographModelFromJson(jsonString);

// ignore_for_file: constant_identifier_names

import 'dart:convert';

HydrographModel hydrographModelFromJson(String str) =>
    HydrographModel.fromJson(json.decode(str));

String hydrographModelToJson(HydrographModel data) =>
...
class DataData {
  ...
  factory DataData.fromJson(Map<String, dynamic> json) => DataData(
        wh: double.parse(json["wh"].toString()),
        time: json["time"],
        flow: double.parse(json["flow"].toString()),
      );
