...
import 'package:telemetry/chart/chart_hydrograph_view_model.dart';
import 'package:telemetry/chart/model/hydrograph_model.dart';
import 'package:telemetry/core/authentication_manager.dart';

class ChartHydrographView extends StatefulWidget {
  const ChartHydrographView({Key? key}) : super(key: key);

  @override
  State<ChartHydrographView> createState() => _ChartHydrographViewState();
}

class _ChartHydrographViewState extends State<ChartHydrographView> {
  late final AuthenticationManager _authManager;
  ChartHydrographViewModel viewModel = Get.put(ChartHydrographViewModel());
          ...
          child: SfCartesianChart(
              ...
              series: <ChartSeries<DataData, String>>[
                ColumnSeries<DataData, String>(
                    ...
                    xValueMapper: (DataData sales, _) => sales.time,
                    yValueMapper: (DataData sales, _) => sales.flow,
                    name: 'FLow',
                    // Enable data label
                    dataLabelSettings:
